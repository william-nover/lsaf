	...
	public function Timeout(){
		...
		if(!empty($signup_id) && !empty($group_id)){
			...
			if(!empty($email_user)){
				...
				$message_email_user .= "<b>LSAF MOI Campus<br>";
                $message_email_user .= "LSAF Global<br>";
				$message_email_user .= "<b>Web :<a href=".BASE_URL.">";
                $message_email_user .= BASE_URL; 
                $message_email_user .= "</a></b><br>";
            	$message_email_user .= "Mall of Indonesia ";
                $message_email_user .= "Italian Walk Block B no. 36 Kelapa Gading Square<br>";
                $message_email_user .= "Jl. Raya Boulevard Barat, Kelapa Gading, Jakarta-14240<br>";
                $message_email_user .= "Tel : 021 293 647 93/96";
			...
			if(!empty($email_user)){
				...
				$message_inv_user .= "Thank you for the inquiry on ACCA programme at London School of Accountancy and Finance.<br>";
				$message_inv_user .= "We are ACCA Gold Approved Learning Provider. ACCA is worlds recognized qualification. In Indonesia, LSAF provides work placement services to ACCA qualified individuals.<br>";
				$message_inv_user .= "To register in our Programme, kindly submit the following :<br>";
				$message_inv_user .= "1. Registration Form - Attached<br>";
				$message_inv_user .= "2. Passport - Scanned Copy<br>";
				$message_inv_user .= "3. Photograph - Scanned Copy<br>";
				$message_inv_user .= "4. Certificate and Transcript of your last qualification - Scanned Copy<br>";
				
				                         
                $message_inv_user .= "For further queries, Do contact us at (021)-2936-4793/96  or Whatsapp me at "; 
				$message_inv_user .= "<b><a href='https://web.whatsapp.com/send?phone=6285720204241&text=Halo, LSAF.'>";
                $message_inv_user .= "+62857-2020-4241";     
				$message_inv_user .= "</a></b><br>";				
				$message_inv_user .= "<b>Thank you,</b><br>";
				$message_inv_user .= "<b>Best Regards, </b><br>";
                $message_inv_user .= "<b>Tyas Kanti Aryandini Djumena</b><br>"; 
                $message_inv_user .= "<b>LSAF Program Manager</b><br>";  
                $message_inv_user .= "<b>London School of Accountancy and Finance</b><br>";
				$message_inv_user .= "<b> Web :<a href=".BASE_URL.">";
                $message_inv_user .= BASE_URL; 
                $message_inv_user .= "</a></b><br>";
				$message_inv_user .= "<b> FB :<a href='www.facebook.com/lsaf.acca.jakarta'>";
                $message_inv_user .= "www.facebook.com/lsaf.acca.jakarta"; 
                $message_inv_user .= "</a></b><br>";
				
				$message_inv_user .= "<b>LSAF MOI Campus<br>";
				...
				$message_inv_user .= "<b>LSAF Majapahit Campus<br>";
                $message_inv_user .= "Jl. Majapahit NO. 10 Petojo Selatan, Gambir Jakarta Pusat.</b><br>";
				
				$message_inv_user .= "<b>LSAF Singapore<br>";
                $message_inv_user .= "Jl20 Maxwell Road #09-17, Singapore, 069113, Singapore.</b><br>";
				
				$message_inv_user .= "<b>LSAF Afghanistan<br>";
                $message_inv_user .= "Debori Square Kariz Road Behind Rahman Baba Hostel 3rd District Kabul, Afghanistan.</b><br>";
				
                $message_inv_user .="T: 021 293 647 93/96<br>";
				$message_inv_user .="HP : 085720204241<br>";
				$message_inv_user .="Your Key To Global Careers<br>";
				$message_inv_user .="----------------------------------";
				$message_inv_user .="<br>";
				$message_inv_user .="<br>";
				$message_inv_user .= "<a href ='https://lsafglobal.com/assets/file_upload/LSAF-Registration-Form.pdf'>Click here to download Registration Form</a><br>";
