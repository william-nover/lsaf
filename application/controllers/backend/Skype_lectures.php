	...
	function sendMail($id, $subject_id, $skype_lectures_title, $skype_lectures_date){
		 ...
		 $getMail = $this->Model_class_management->getMail($subject_id);
                 ...
                 foreach ($getMail as $gm) {
                  ...
                  $link = BASE_URL."/Skype_lectures/detail/" .$id; 
                $subject = "Promo – Skype Lectures";
				
                $message_email = "Are you interested in a particular subject but not quite sure on how to  effectively self-study? Or perhaps you are interested in taking up a professional qualification but not being able to go to a learning  institution to do so?<br>";			
                $message_email .= "Look no further! London School of Accountancy & Finance provides flexibility in its methods of study by providing classes via an electronic  telecommunication platform, i.e. Skype. Simply register your interest by calling or visiting us and we'll be more than happy to provide you with the details.<br>";
                $message_email .= "New Skype lectures"  .$skype_lectures_title."<br>";
                $message_email .= "For Subject : ".$subject_title.'--'.$skype_lectures_date."<br>";
                $message_email .= '<a href="'.$link.'">Click the following link to access it.<a>';
                $message_email .= "<br>";
                $message_email .= "<br>";
                $message_email .= "For any further inquiries or feedback, do not hesitate to inform administration. Thank you.<br>";
                $message_email .= "Regards<br>";
                $message_email .= "LSAF Management and Team<br>";
                $message_email .= "LSAF – Your Key To Global Success<br>";
                $message_email .= "+6221 2936 4793 / 96<br>";
