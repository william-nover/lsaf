...
//                die;
	...
	function sendMail($id, $subject_id, $video_lectures_title, $video_lectures_date){
		 ...
		 $getMail = $this->Model_class_management->getMail($subject_id);
                ...
                $link = BASE_URL."/Video_lectures/detail/".$id;
                $subject = "Update: Lecture Video ";
			    $message_email = "Dear LSAF Students<br>";
				$message_email .= "A new lecture video has been posted to MyLSAF. Increase your chances of success by taking the<br>";
				$message_email .= "benefit of a lecture video to support your studies. <br>";			    
...
//echo '<br> kepada'.$email.'<br> subject'.$subject.'<br> pesan'.$message_email.'<br> judul'.$header;	
//die;			   
