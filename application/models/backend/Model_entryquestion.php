...
class Model_entryquestion extends CI_Model {
	...
	function getListQuestion($cond = null){
		$query		= "SELECT a.entry_question_id, a.entry_question_title, a.entry_question_images, a.entry_question_active_status, a.entry_question_order,
	...
	function insertQuestion($entry_questiontitle,$entry_question_images,$entry_groupid){
		$sql	= "INSERT INTO tbl_entry_question SET 
					entry_question_title = '".$entry_questiontitle."',
                                        entry_question_images = '".$entry_question_images."',
	...
	function getQuestion($id = ''){
		...
		$sql	= "SELECT entry_question_id, entry_question_title, entry_question_images, entry_question_active_status, entry_question_order, entry_group_id 
	...
	function updateQuestion($id,$entry_questiontitle,$entry_question_images,$entry_groupid){
