...
class Model_menu_frontend extends CI_Model {
	...
	function getListMenu($cond = null){
		 ...
		 $query		= "SELECT menu_id,module_id,menu_title, menu_active_status, menu_parent,menu_sub_parent, menu_url, menu_order,
	...
	function getMenuChildren($parent){
		 $query		= "SELECT a.menu_id,a.module_id, a.menu_title, a.menu_url, Deriv1.Count FROM 
	...
	function getMenu($id = '')
	{
		...
		$sql	= "SELECT menu_id, module_id, menu_title, menu_active_status, menu_parent, menu_url, menu_order FROM tbl_menu $where ORDER BY menu_id ASC";	
       ...
       function getParent($menu_id)
	{
        ...
        function GenerateMenu()
            {
		 $data = array();
			 $sql = "SELECT menu_id, menu_title,module_id, menu_active_status, menu_parent,menu_sub_parent, menu_url, menu_order,
					  DATE_FORMAT( menu_create_date, '%d-%m-%Y %H:%i:%s' ) as menu_create_date, menu_create_by
					  FROM tbl_menu as a where a.menu_parent = 0 and a.menu_active_status=1  ORDER BY menu_order ASC";
			$query = $this->db->query($sql);
	...
	{
		 $data = array();
			 $sql = "SELECT a.menu_id,a.menu_parent,a.menu_sub_parent,a.menu_title,a.menu_url from tbl_menu as a  where   a.menu_sub_parent= 0 and menu_parent= '".$menu_id."' ORDER BY a.menu_order ASC";
			$query = $this->db->query($sql);
			if($query->num_rows() > 0){
	...
	{
		 $data = array();
			 $sql = "SELECT a.menu_id,a.menu_parent,a.menu_sub_parent,a.menu_title,a.menu_url from tbl_menu as a  where  a.menu_sub_parent ='".$menu_id."' and a.menu_parent= '".$menu_parent."' ORDER BY a.menu_order ASC";
			$query = $this->db->query($sql);
			if($query->num_rows() > 0){
       ...
       function getMenuContent($module_id)
		 ...
		 $data = array();
			 $sql = "SELECT a.menu_id, a.menu_title, a.menu_parent, a.menu_sub_parent, a.menu_url, b.module_id, b.module_name "
                                 . "FROM tbl_menu as a "
                                 . "INNER JOIN tbl_module as b on a.module_id = b.module_id where a.menu_parent = 0 and a.module_id = '".$module_id."'";
			$query = $this->db->query($sql);
           ...
           function getSecond($menu_id,$menu_parent)
	{
        ...
        function GenerateFooterAA()
            {
		 $data = array();
		 	$sql = "SELECT menu_id, menu_title,module_id, menu_url FROM tbl_menu as a where a.menu_parent = 0 and a.menu_active_status=1 and module_id=15";
			$query = $this->db->query($sql);
        ...
        function GenerateFooterAB()
            {
		 $data = array();
		 	 $sql = "SELECT menu_id, menu_title,module_id, menu_url FROM tbl_menu as a where a.menu_parent = 0 and a.menu_active_status=1 and module_id=17";
			$query = $this->db->query($sql);
        ...
        function GenerateFooterBA()
            {
		 $data = array();
			 $sql = "SELECT menu_id, menu_title,module_id, menu_url FROM tbl_menu as a where a.menu_parent = 0 and a.menu_active_status=1 and module_id=16 limit 0,5";
			$query = $this->db->query($sql);
                        ...
                        foreach($query->result() as $row)
		{
           ...
           function GenerateFooterBB()
            {
		 $data = array();
			 $sql = "SELECT menu_id, menu_title,module_id, menu_url FROM tbl_menu as a where a.menu_parent = 0 and a.menu_active_status=1 and module_id=16 limit 5,6";
			$query = $this->db->query($sql);
        ...
        function GenerateFooterC()
            {
		 $data = array();
			 $sql = "SELECT menu_id, menu_title,module_id,menu_url FROM tbl_menu as a where a.menu_parent = 0 and a.menu_active_status=1 and module_id=18";
			$query = $this->db->query($sql);
