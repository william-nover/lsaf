							 ...
							 <div class="col-lg-10">
								  <div class="form-group">
									  <select name="searchby" id="search-by" size="1" class="form-control">
										...
										<option value="register_id" <?php if($searchby == "register_id") { echo "selected"; }?> >Register Id</option>
										<option value="full_name" <?php if($searchby == "full_name") { echo "selected"; }?> >Full Name</option>
									</select>
								  </div>
								  <div class="form-group">
