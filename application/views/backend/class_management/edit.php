                  ...
                  <div class="col-lg-12">
					<section class="panel">
                          ...
                          <div class="panel-body">
                            <form name="form1" action="<?php echo BASE_URL_BACKEND.'/class_management/doEdit/'.$rsClass_management[0]['class_management_id']; ?>" method="post" class="form-horizontal" role="form">
                                  <?php if(isset($error)){ ?>
                                      ...
                                      <div class="col-lg-6">
                                          <select class="form-control" name="student_id" id="student_id">           
                                            <?php foreach($getStudent as $gst){ ?> 
                                              <option value="<?php echo $gst->student_id;?>" <?php if($gst->student_id ==  $rsClass_management[0]['student_id']) { echo "selected";} ?>> <?php echo $gst->full_name;?> </option>
                                            <?php } ?>
                                          </select>
                                      </div>
                                 </div> 
                                <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <select class="form-control" name="subject_id" id="subject_id"> 
                                            <?php foreach($getSubject as $gs){ ?> 
                                              <option value="<?php echo $gs->subject_id;?>" <?php if($gs->subject_id ==  $rsClass_management[0]['subject_id']) { echo "selected";} ?>> <?php echo $gs->subject_title;?> </option>
                                            <?php } ?>
                                          </select>
                                      </div>
                                 </div> 
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
                                        <input class="form-control" size="16" type="text" value="<?php echo $rsClass_management[0]['class_management_start_date']; ?>" >
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                    </div>
                                    <input type="hidden" id="dtp_input1" name="class_management_start_date" value="<?php echo $rsClass_management[0]['class_management_start_date']; ?>" /><br/>
                                </div>
                                <div class="form-group">
                                    <label for="dtp_input2" class="col-md-2 control-label">End Date</label>
                                    <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                        <input class="form-control" size="16" type="text" value="<?php echo $rsClass_management[0]['class_management_end_date']; ?>" >
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                    </div>
                                    <input type="hidden" id="dtp_input2" name="class_management_end_date" value="<?php echo $rsClass_management[0]['class_management_end_date']; ?>" /><br/>
                                </div> 
                                  </div>
                                <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                  <input name="tbEdit" class="btn btn-info btn-sm" type="submit" value="Save">&nbsp;
                                  <input name="cancel" class="btn btn-info btn-sm" type="button" value="Cancel" onClick="location.href='<?php echo BASE_URL_BACKEND.'/class_management'; ?>'">
                                </div>
                                </div>
                              </form>
                          </div>
