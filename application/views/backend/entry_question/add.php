								  ...
								  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
										  ...
										  <input type="text" name="entry_question_images" readonly="readonly" id="imageurl" class="form-control" placeholder="Question Images" value="<?php if(!empty($entry_question_images)){echo $entry_question_images;} ?>">
