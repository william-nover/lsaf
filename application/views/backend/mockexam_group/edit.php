                  ...
                  <div class="col-lg-12">
					<section class="panel">
                          ...
                          <div class="panel-body">
							  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/mock_exam_group/doEdit/'.$rsGroup[0]['mock_exam_group_id']; ?>" method="post" class="form-horizontal" role="form">
                                 <?php if(isset($error)){ ?>
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="mock_exam_grouptitle" type="text" class="form-control" placeholder="Group Title" value="<?php echo $rsGroup[0]['mock_exam_group_title']; ?>">
                                          <input name="mock_exam_grouptitleOld" type="hidden" class="form-control" placeholder="Group Title" value="<?php echo $rsGroup[0]['mock_exam_group_title']; ?>">
									 </div>
                                  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="mock_exam_groupstart" id="mock_exam_groupstart" type="text" class="form-control" readonly placeholder="Start Date" value="<?php echo $rsGroup[0]['mock_exam_group_start']; ?>">
									 </div>
                                  </div>
								  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Start End</label>
                                      <div class="col-lg-4">
                                          <input name="mock_exam_groupend" id="mock_exam_groupend" type="text" class="form-control" readonly placeholder="End Date" value="<?php echo $rsGroup[0]['mock_exam_group_end']; ?>">
									 </div>
                                  </div>
								  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Group Timer</label>
                                      <div class="col-lg-4">
                                          <input name="mock_exam_grouptimer" type="text" class="form-control" placeholder="Group Timer" value="<?php echo $rsGroup[0]['mock_exam_group_timer']; ?>">
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="mock_exam_grouptimeressay" type="text" class="form-control" placeholder="Group Timer Essay" value="<?php echo $rsGroup[0]['mock_exam_group_timer_essay']; ?>">
										  <p class="help-block" style="color:#00F;">in seconds</p>
									  </div>
                                  </div>
                                  <div class="form-group">
