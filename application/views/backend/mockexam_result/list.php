              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
						  ...
						  <form class="form-inline" role="form" method="post" name="frmSearch" action="<?php echo BASE_URL_BACKEND."/mock_exam_result/view"; ?>">
						  <div class="panel-body">
							 <div class="col-lg-10">
								  <div class="form-group">
									  <select name="searchby" id="search-by" size="1" class="form-control">
										...
										<option value="c.mock_exam_group_title" <?php if($searchby == "c.mock_exam_group_title") { echo "selected"; }?> >Group Title</option>
								  ...
								  <tr>
									  ...
									  if(count($data['multiple_choice'])){
										  ...
										  foreach($data['multiple_choice'] as $key => $value){
											...
											$score = round(($value['mock_exam_result_value'] / $value['total_question']) * $percent, 2);
											echo "<tr>";
											echo "<td>Attempt ".$value['attempt']."</td>";
											echo "<td>".$score."</td>";
											echo "<td>".$value['mock_exam_result_create_date']."</td>";
									  ...
									  if(count($data['essay'])){
										  ...
										  foreach($data['essay'] as $key => $value){
											...
											$score = round(($value['mock_exam_essay_value'] / 100) * $percent, 2);
											echo "<tr>";
											echo "<td>Attempt ".$value['attempt']."</td>";
											echo "<td>".$score."</td>";
											echo "<td>".$value['mock_exam_essay_create_date']."</td>";
											echo "<td><a href='".BASE_URL."/assets/upload/".$value['mock_exam_essay_file']."'>File</a></td>";
											if($edit){ 
											echo "<td>";
											echo '<a class="btn-primary btn-sm" title="Click to Edit" href="'.BASE_URL_BACKEND.'/mock_exam_result/editEssay/'.$value['mock_exam_essay_id'].'"><i class="icon-pencil"></i></a>';
											echo "</td>";
											}
											echo "</tr>";
										  }
