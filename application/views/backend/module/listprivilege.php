                              ...
                              <section id="unseen">
                                <table class="table table-bordered table-striped table-condensed">
								  ...
								  <tr>
									  ...
									  <td>
											<a class="btn-danger btn-sm" title="Click to Delete" onclick="var answer = confirm('delete privilege <?php echo $moduleprivilege['privilege_name'];?> ?'); if (answer){window.location = '<?php echo BASE_URL_BACKEND;?>/module/deletemoduleprivilege/<?php echo $moduleprivilege['module_privilege_id'];?>/<?php echo $id;?>';}"><span class="icon-trash"></span></a> &nbsp; 
									  </td>
								  </tr>
								  <?php } ?>
                                  </tbody>
