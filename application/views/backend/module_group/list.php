              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
						  ...
						  <form class="form-inline" role="form" method="post" name="frmSearch" action="<?php echo BASE_URL_BACKEND."/module_group/view"; ?>">
						  <div class="panel-body">
							 <div class="col-lg-10">
								  <div class="form-group">
									  <select name="searchby" id="search-by" size="1" class="form-control">
										<option value="">Choose a search</option>
										<option value="module_group_name" <?php if($searchby == "module_group_name") { echo "selected"; }?> >Module Group</option>
									</select>
								  </div>
								  <div class="form-group">
                                ...
                                <table class="table table-bordered table-striped table-condensed">
								  ...
								  <tr>
									  ...
									  <?php if($group['module_group_active_status'] == 1) {?>
											<a class="btn-success btn-sm" title="Click to Inactive" href="<?php echo BASE_URL_BACKEND."/module_group/active/".$group['module_group_id'];?>"><i class="icon-ok"></i></a> &nbsp; 
									  <?php } else { ?>	
											<a class="btn-danger btn-sm" title="Click to Active" href="<?php echo BASE_URL_BACKEND."/module_group/active/".$group['module_group_id'];?>"><i class="icon-remove"></i></a> &nbsp;
									  <?php } ?>
											<a class="btn-primary btn-sm" title="Click to Edit" href="<?php echo BASE_URL_BACKEND;?>/module_group/edit/<?php echo $group['module_group_id'];?>"><i class="icon-pencil"></i></a> &nbsp; 
											<a class="btn-danger btn-sm" title="Click to Delete" onclick="var answer = confirm('delete grup <?php echo $group['module_group_name'];?> ?'); if (answer){window.location = '<?php echo BASE_URL_BACKEND;?>/module_group/delete/<?php echo $group['module_group_id'];?>';}"><span class="icon-trash"></span></a>
									  </td>
