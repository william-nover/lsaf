                  ...
                  <div class="col-lg-12">
					<section class="panel">
                          ...
                          <div class="panel-body">
							  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/progress_exam_group/doAdd'; ?>" method="post" class="form-horizontal" role="form">
                                  <?php if(isset($error)){ ?>
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="progress_exam_grouptitle" type="text" class="form-control" placeholder="Group Title" value="<?php if(!empty($progress_exam_grouptitle)){echo $progress_exam_grouptitle;} ?>">
                                      </div>
                                  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="progress_exam_groupstart" id="progress_exam_groupstart" type="text" class="form-control" readonly placeholder="Start Date" value="<?php if(!empty($progress_exam_groupstart)){echo $progress_exam_groupstart;} ?>">
									 </div>
                                  </div>
								  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Start End</label>
                                      <div class="col-lg-4">
                                          <input name="progress_exam_groupend" id="progress_exam_groupend" type="text" class="form-control" readonly placeholder="End Date" value="<?php if(!empty($progress_exam_groupend)){echo $progress_exam_groupend;} ?>">
									 </div>
                                  </div>
								  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Group Timer</label>
                                      <div class="col-lg-4">
                                          <input name="progress_exam_grouptimer" type="text" class="form-control" placeholder="Group Timer" onKeyPress="return isNumberKey(event)" value="<?php if(!empty($progress_exam_grouptimer)){echo $progress_exam_grouptimer;} ?>">
								  ...
								  <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                          <input name="progress_exam_grouptimeressay" type="text" class="form-control" placeholder="Group Timer Essay" onKeyPress="return isNumberKey(event)" value="<?php if(!empty($progress_exam_grouptimeressay)){echo $progress_exam_grouptimeressay;} ?>">
										  <p class="help-block" style="color:#00F;">in seconds</p>
									 </div>
                                  </div>
                                  <div class="form-group">
