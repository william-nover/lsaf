					...
					<section class="panel">
                          ...
                          <div class="panel-body">
                            <form name="form1" action="<?php echo BASE_URL_BACKEND.'/skype_lectures/doAdd'; ?>" method="post" class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                      <label for="subjecttitle" class="col-lg-2 col-sm-2 control-label">Skype Link / ID</label>
                                      <div class="col-lg-4">
                                                <input name="skype_lectures_link" type="text" class="form-control" placeholder="skype link / ID" value="<?php if(!empty($skype_lectures_link)){echo $skype_lectures_link;} ?>">
                                    </div>
                                </div>                         
                                <div class="form-group">
