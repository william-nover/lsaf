							 ...
							 <div class="col-lg-10">
								  <div class="form-group">
									  <select name="searchby" id="search-by" size="1" class="form-control">
										...
										<option value="subject_title" <?php if($searchby == "subject_title") { echo "selected"; }?> >Menu Title</option>
									</select>
								  </div>
								  <div class="form-group">
                                ...
                                <table class="table table-bordered table-striped table-condensed">
                                  ...
                                  <form name="formAssignment" method="POST" action="" onsubmit="return false;">
                                    ...
                                    <tr>
                                            ...
                                            <td><?php echo $subject['level_title'];?></td>
                                            <td><?php echo $subject['lecturer_name'];?></td>
                                            <td><?php echo $subject['subject_create_date'];?></td>
                                            <?php if($order){ ?>
                                                  <td align="center"><input type="text" class="form-control" style="text-align:center;" name="order[<?php echo $subject['subject_id'];?>]" size="1" maxlength="2" value="<?php echo $subject['subject_order'];?>"></td>
                                            <?php } ?>
                                            <td>
                                                  <?php if($approve){ ?>
