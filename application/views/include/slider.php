                    ...
                    <?php $i= 0;foreach($dataBannerHome as $banner){ ?>
                        ...
                        <div data-b="<?php echo $i;?>" data-p="170.00" style="display: none;">
                             <?php if(!empty($banner['banner_url'])){?>
                                        ...
                                        <?php } else { ?>
                                               <a u=image href="#">  <img src="<?php echo $banner['banner_images'];?>" <?php if(!empty($banner['banner_name'])){?> alt="<?php echo $banner['banner_name'];?>" <?php } ?>/></a>
                                        <?php } ?> 
                  <?php if(!empty($banner['banner_desc']) ){?>
