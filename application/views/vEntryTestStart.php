...
<div class="question">
	...
	<?php if(!empty($examQuestion['entry_question_images'])){ ?>
	<a id="questionImage" href="<?php echo $examQuestion['entry_question_images'];?>"><img src="<?php echo $examQuestion['entry_question_images'];?>" title="Question <?php echo $page;?>" height="365" class="gmbr-question" ></a>
	<?php } ?>
