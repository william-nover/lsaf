...
<html>
<head>
<?php  error_reporting( E_ERROR | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR |
E_COMPILE_WARNING ); include "include/style.php"; ?>
            	...
            	<div class="header-content">  </div> 
                 ...
                 <div id="container" class="das-table">
                   <div class="das-r-menu">
                     ...
                     ?>  
                    <ul class="rtabs">
                        <li><a href="<?php echo BASE_URL;?>/Module_lectures/<?php echo $prev;?>"><< Prev</a></li>
                        <li><a href="<?php echo BASE_URL;?>/Module_lectures/<?php echo $next;?>">Next >>   </a></li>
                                  ...
                                  <form name="formAssignment" method="POST" action="" onsubmit="return false;">
                                    ...
                                    <tr>    
                                          <td><?php echo $no;?></td>
                                            ...
                                            <td>
                                                <a href="<?php echo BASE_URL;?>/Module_lectures/detail/<?php echo $vl['module_lectures_id'];?>"><?php echo $vl['module_lectures_link'];?></a>
                                            </td>
