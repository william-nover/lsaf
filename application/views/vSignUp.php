   ...
   <div class="sign-up">
    	<div class="sign-up-left">
         ...
         <div class="sign-up-right">
                    ...
                    <span>Nationality </span>
                     <select id="country_id" class="" name="country_id">
                        <?php foreach ($Nationality as $nat) { ?>
                         <option value="<?php echo $nat-> country_id;?>" <?php if ($nat-> country_id == 111) echo 'selected';?>><?php echo $nat->country_name ;?></option>       
                        <?php } ?>                    
                    </select>
                </label>
                <div class="clear"> </div> 
             ...
             <p>By clicking Sign Up, you agree to our  <a href="<?php echo BASE_URL.'/Terms_Condition';?>">Terms and Conditions.</a></p>
             <?php echo form_close(); ?>
