...
<html>
<head>
<title>Take Test - Progress Exam - <?php echo $rsProgressExamSchedule[0]['subject_title']; ?></title>
...
<div class="container">	
   ...
   <div class="dasboard">
		...
		<div class="dasboard-right">
			...
			<div class="clear"> </div>
			<h3> Progress Exam - <?php echo $rsProgressExamSchedule[0]['subject_title']; ?> </h3>
			<?php if($countQuestionMultiple > 0) { ?>
				...
				<?php } else { ?>
					<a href="<?php echo BASE_URL; ?>/Progress_test/Start/<?php echo $rsProgressExamSchedule[0]['progress_exam_group_id'];?>/1"><div id="take-test"><span>Multiple Choice</span><br><span id="date">Attempt <?php echo $attempt_multiplechoice;?></span></div></a>
				<?php } ?>
			<?php } else { ?>
			...
			<?php if($countQuestionEssay > 0) { ?>
				...
				<?php } else { ?>
					<?php if($attempt_multiplechoice > 0) { ?>
						<a href="<?php echo BASE_URL; ?>/Progress_test/Start/<?php echo $rsProgressExamSchedule[0]['progress_exam_group_id'];?>/2"><div id="take-test"><span>Essay</span><br><span id="date">Attempt <?php echo $attempt_essay;?></span></div></a>
					<?php } else { ?>
						<div id="take-test"><span>Essay</span><br><span id="date">Attempt <?php echo $attempt_essay;?></span></div>
					<?php } ?>
				<?php } ?>
