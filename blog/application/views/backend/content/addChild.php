               ...
               <div class="d-flex align-items-center">
                  <div class="mr-auto">
                     <h3 class="m-subheader__title m-subheader__title--separator">
                        <?php echo $breadcrump['module_group_name']; ?> Sub - <?php echo $breadcrump['module_name']; ?> -  ADD
                     </h3>
                  </div>
               </div>
            </div>
                           ...
                           <div class="m-form__actions m-form__actions--solid">
                              <div class="row">
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <input name="cancel" class="btn btn-danger btn-sm" type="button" value="Cancel" onClick="location.href='<?php echo BASE_URL_BACKEND.'/'.$controller.'/child/'.$label_id.'/'.$content_id; ?>'">                                                      
                                 </div>
                              </div>
                           </div>
                        </div>
