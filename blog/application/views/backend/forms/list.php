                              ...
                              <tbody>
                                   <?php
                                    ...
                                    <tr>
                                      ...
                                      <td style="font-size: 12px;"><?php echo getForms($forms['forms_title']);?></td>
                                      <td style="font-size: 12px;"><?php echo $forms['forms_email'];?></td>
                                      <td style="font-size: 12px;"><?php echo $forms['forms_cc'];?></td>
                                      <td style="font-size: 11px;"><?php echo $forms['forms_bcc'];?></td>
                                     
                                      
                                     <td>
                                          <?php if($approve){ ?>
                                          <?php if($forms['forms_active_status'] == 1) {?>
                                          <a class="btn-success btn-sm" title="Click to Inactive" href="<?php echo BASE_URL_BACKEND."/".$controller."/active/".$forms['forms_id'];?>"><i class="la la-check-circle"></i></a> &nbsp; 
                                          <?php } else { ?>
                                          <a class="btn-warning btn-sm" title="Click to Active" href="<?php echo BASE_URL_BACKEND."/".$controller."/active/".$forms['forms_id'];?>"><i class="la la-power-off"></i></a> &nbsp;
                                          <?php } ?>
                                          <?php } ?>
                                          <?php if($edit){ ?>
                                          <a class="btn-primary btn-sm" title="Click to Edit" href="<?php echo BASE_URL_BACKEND.'/'.$controller;?>/edit/<?php echo $forms['forms_id'];?>"><i class="la la-edit"></i></a> &nbsp; 
                                          <?php } ?>
                                          <?php if($delete){ ?>
                                          <a class="btn-danger btn-sm" title="Click to Delete" onclick="var answer = confirm('delete <?php echo $forms['forms_title'];?> ?'); if (answer){window.location = '<?php echo BASE_URL_BACKEND.'/'.$controller;?>/delete/<?php echo $forms['forms_id'];?>';}"><span class="la la-trash"></span></a> &nbsp;
                                          <?php } ?>
                                       </td>
                                        </tr>
