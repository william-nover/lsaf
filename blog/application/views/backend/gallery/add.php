...
<body class="m-page--fluid m--skin- m-content--skin-light2 m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
                           ...
                           <div class="col-lg-6">
                              <select class="form-control" name="module_id" id="module_id">                                            
                                ...
                                <?php foreach($allModule as $Modul){ ?>
                                        ...
                                        <option value="<?php echo $Modul['module_id'];?>"> <?php echo $Modul['module_name'];?> </option>
                           ...
                           <div class="m-form__actions m-form__actions--solid">
                              <div class="row">
                                 ...
                                 <div class="col-lg-6">
                                    ...
                                    <input name="cancel" class="btn btn-danger btn-sm" type="button" value="Cancel" onClick="location.href='<?php echo BASE_URL_BACKEND.'/dine'; ?>'">                                                      
                                 </div>
                              </div>
                           </div>
                        </div>
   ...
   <script language="javascript">
      ...
      if(answer){
      frm.action = '<?php echo BASE_URL_BACKEND;?>/dine/doOrder';
      frm.submit();
      } else {
      return false;
      }
