      ...
      <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
         ...
         <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-content">
                ...
                <!--begin::Form-->
                <form name="form1" action="<?php echo BASE_URL_BACKEND.'/module_group/doEdit/'.$rsGroup[0]['module_group_id']; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                    <?php if(isset($error)){ ?>
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <input name="groupname" type="text" class="form-control m-input"placeholder="Module Group Name" value="<?php echo $rsGroup[0]['module_group_name']; ?>">
