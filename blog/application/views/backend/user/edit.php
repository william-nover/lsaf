         ...
         <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-content">
               <div class="m-portlet">
                  ...
                  <!--begin::Form-->
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/user/doEdit/'.$rsUser[0]['user_id']; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                     <?php if(isset($error)){ ?>
                     ...
                     <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="username" type="text" class="form-control m-input" placeholder="User Name" value="<?php echo $rsUser[0]['user_name']; ?>">
                        ...
                        <div class="form-group m-form__group row">
                           ...
                           <div class="col-lg-6">
                              <input name="email" type="text" class="form-control m-input" placeholder="Email" value="<?php echo $rsUser[0]['user_email']; ?>">
                              <span class="m-form__help">
