         ...
         <div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="m-content">
               <div class="m-portlet">
                  ...
                  <!--begin::Form-->
                  <form name="form1" action="<?php echo BASE_URL_BACKEND.'/userlevel/doEdit/'.$rsUserLevel[0]['user_level_id']; ?>" method="post" role="form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator">
                    <?php if(isset($error)){ ?>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6">
                                    <input name="userlevelname" type="text" class="form-control m-input"placeholder="User Level Name" value="<?php echo $rsUserLevel[0]['user_level_name']; ?>">
                        ...
                        <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-lg-6">
                                                <textarea name="userleveldesc" class="form-control m-input" rows="5"><?php echo $rsUserLevel[0]['user_level_desc']; ?></textarea>
                                                <span class="m-form__help">
