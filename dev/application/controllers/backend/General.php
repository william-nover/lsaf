...
class General extends CI_Controller {
	...
	public $module_id = 1; //get module id from database
	...
	public function __construct()
	{
		...
		$this->load->model(array('backend/Model_general', 'backend/Model_language','backend/Model_logcms'));
	...
	function view(){
		...
		$this->load->view('backend/general/list');
	}
	...
	public function edit($id){
		...
		$this->load->view('backend/header',$this->data);
		$this->load->view('backend/general/edit',$this->data);
	}
