...
class Model_student extends CI_Model {
	...
	function insertStudent($module_level_id,$lecturer_id,$student_name)
	{
		$sql	= "INSERT INTO tbl_student SET module_level_id = '".$module_level_id."',lecturer_id = '".$lecturer_id."', student_name = '".$student_name."',
	...
	function insertStudentLang($student_name,$subjectid,$languageid)
	{
		$sql	= "INSERT INTO tbl_student_lang SET student_lang_title = '".$student_name."',
					student_id = ".$subjectid.", language_id = ".$languageid.",
					student_lang_create_by = ".$_SESSION['admin_data']['user_id'].", student_lang_create_date = now()";	
		$query  = $this->db->query($sql);
		$last_id  = $this->db->insert_id();
