                  ...
                  <div class="col-lg-12">
					<section class="panel">
                          ...
                          <div class="panel-body">
                            <form name="form1" action="<?php echo BASE_URL_BACKEND.'/module_lectures/doEdit/'.$rsModule_Lectures[0]['module_lectures_id']; ?>" method="post" class="form-horizontal" role="form">
                                  <?php if(isset($error)){ ?>
                                ...
                                <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Module Title</label>
                                      <div class="col-lg-4">
                                        <input name="module_lectures_title" type="text" class="form-control" placeholder="Module Title" value="<?php echo $rsModule_Lectures[0]['module_lectures_title']; ?>">
                                        <input name="module_lectures_titleOld" type="hidden" value="<?php echo $rsModule_Lectures[0]['module_lectures_title']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Module link</label>
                                      <div class="col-lg-4">
                                        <input name="module_lectures_link" type="text" class="form-control" placeholder="Module Title" value="<?php echo $rsModule_Lectures[0]['module_lectures_link']; ?>">
                                 ...
                                 <div class="form-group">
                                      ...
                                      <div class="col-lg-4">
                                        ...
                                        <input type="text" name="module_lectures_link" readonly="readonly" id="fileurl" class="form-control" value="<?php echo $rsModule_Lectures[0]['module_lectures_link']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                        <input class="form-control" size="16" type="text" value="<?php echo $rsModule_Lectures[0]['module_lectures_date']; ?>" >
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                    </div>
                                        <input type="hidden" id="dtp_input2" name="module_lectures_date" value="<?php echo $rsModule_Lectures[0]['module_lectures_date']; ?>" /><br/>
                                </div>
                                <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <select class="form-control" name="subject_id" id="subject_id">                                            
                                            <?php foreach($getSubject as $gs){ ?> 
                                              <option value="<?php echo $gs->subject_id;?>" <?php if($gs->subject_id ==  $rsModule_Lectures[0]['subject_id']) { echo "selected";} ?>> <?php echo $gs->subject_title;?> </option>
                                            <?php } ?>
                                          </select>
                                      </div>
                                 </div>                            
