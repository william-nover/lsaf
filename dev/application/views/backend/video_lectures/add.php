                  ...
                  <div class="col-lg-12">
					<section class="panel">
                          ...
                          <div class="panel-body">
                            <form name="form1" action="<?php echo BASE_URL_BACKEND.'/video_lectures/doAdd'; ?>" method="post" class="form-horizontal" role="form">
                                  <?php if(isset($error)){ ?>
                                ...
                                <div class="form-group">
                                      <label for="subjecttitle" class="col-lg-2 col-sm-2 control-label">Video Title</label>
                                      <div class="col-lg-4">
                                                <input name="video_lectures_title" type="text" class="form-control" placeholder="video title" value="<?php if(!empty($video_lectures_title)){echo $video_lectures_title;} ?>">
                                        </div>
                                </div> 
                                <div class="form-group">
                                      <label for="subjecttitle" class="col-lg-2 col-sm-2 control-label">Video Embed Code</label>
                                       <div class="col-lg-10">
                                        <textarea id="video_lectures_link" name="video_lectures_link" class="form-control" placeholder="Content Short Description" rows="4"><?php if(!empty($video_lectures_link)){echo $video_lectures_link;} ?></textarea>
                                        <script>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group date form_date col-md-5" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                        ...
                                        <input type="hidden" id="dtp_input2" name="video_lectures_date" value="" /><br/>
                                </div>
                                 <div class="form-group">
