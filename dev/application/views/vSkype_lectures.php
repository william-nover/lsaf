            ...
            <div class="dasboard-right">
               ...
               <div id="container" class="das-table">
                   <div class="das-r-menu">
                     ...
                     ?>  
                    <ul class="rtabs">
                        <li><a href="<?php echo BASE_URL;?>/Skype_lectures/<?php echo $prev;?>"><< Prev</a></li>
                        <li><a href="<?php echo BASE_URL;?>/Skype_lectures/<?php echo $next;?>">Next >>   </a></li>
                                ...
                                <table class="gridtable">
                                  ...
                                  <form name="formAssignment" method="POST" action="" onsubmit="return false;">
                                    <?php
                                          ...
                                          $no=0;
                                          foreach($ListSkype_Lectures as $vl){
                                                  $no++;
                                    ?>
                                    <tr>    
                                          <td><?php echo $no;?></td>
                                            <td><?php echo $vl['skype_lectures_title'];?></td>
                                            
                                            <td>
                                                <a href="<?php echo BASE_URL;?>/Skype_lectures/detail/<?php echo $vl['skype_lectures_id'];?>"><?php echo $vl['skype_lectures_link'];?></a>
                                            </td>
                                            <td><?php echo $vl['skype_lectures_date'];?></td>
