	...
	<div class="dasboard">
            ...
            <?php foreach ($getPersonal as $gp) { ?>
                <table class="gridtable2">        
                    ...
                    <div class="foto-das"> <img src="images/foto-das.png"> </div>
                 </table>
                 
                <a href="<?php echo BASE_URL;?>/Student_info/edit/<?php echo $gp->signup_id ;?>"> <button class="edit-pro"> edit profile </button> </a>
